...
void CreateBrightness()
{
    ...
    lv_obj_set_height(brightness_container, LV_SIZE_CONTENT);  // grow/shrink based on content
    lv_obj_set_style_pad_bottom(brightness_container, 0, LV_PART_MAIN);
    ...
    lv_obj_set_style_pad_left(brightness_sliderandlabel_container, 15, LV_PART_MAIN);
    ...
    lv_obj_set_style_pad_left(brightness_slider, 6, LV_PART_KNOB);
...
void CreateDarkMode()
{
    ...
    lv_obj_set_style_margin_left(darkmode_switch, 3, LV_PART_MAIN);
