// order is important. TJpg_Decoder redefines some functions included in lvgl.h
...
#include "logging.h"
///Users/jordysimpson/Documents/Arduino/libraries/LVGL_CYD/src/LVGL_CYD.h
...
void setup()
{
    ...
    logit("call img button func");
    create_image_button_from_sd();
    logit("back, done with setup");


    LVGL_CYD::tft->fillScreen(TFT_RED);
    LVGL_CYD::tft->setTextColor(0xFFFF, 0x0000);
    LVGL_CYD::tft->drawCentreString("Hello World", LVGL_CYD::tft->width() / 2, 20, 2);
}
